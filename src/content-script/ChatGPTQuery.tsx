...
function ChatGPTQuery(props: Props) {
  const defaultProvider = useSWR('defaultProvider', async () => {
    const configs = await getProviderConfigs()
    return configs.provider
  }).data
  const [overrideProvider, setOverrideProvider] = useState<ProviderType | undefined>()
  ...
  }, [provider, props.question, props.searchItems, retry])
        ...
        <div className="gpt-header">
          <span className="font-bold">
            <select
              ...
              onChange={(e) => {
                setAnswer(null)
                setOverrideProvider(e.target.value as ProviderType)
              }}
            >
              <option value={ProviderType.ChatGPT}>ChatGPT</option>
              <option value={ProviderType.Bard}>Bard</option>
              <option value={ProviderType.ChatGPTPrompt}>All-Info-Digger</option>
            </select>
          </span>
